...
$q = $_GET['q'];
$res = mysqli_query($con,"SELECT * FROM doctorschedule, doctor WHERE Date ='$q' and icDoctor = doctorIc");
if (!$res && !$docres) {
...
if (isset($_POST['submit'])) {
    ...
    $reszap = mysqli_query($con,"SELECT a.*, b.* FROM doctorschedule a, patient b
    WHERE a.Date='$Date' AND scheduleId=$Id AND b.icPatient=$session");
